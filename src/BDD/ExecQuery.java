...
public class ExecQuery {
    ...
    public void execQ() throws ClassNotFoundException, SQLException {
        ...
        rq.request("INSERT INTO OBJET VALUES(150, 0, 2, 3, 0, 5, 0, 0, 0, 0, 0, 0, 'ressources/equip/armures/robe_t0.png', 'Robe de débutant', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(151, 1, 2, 3, 5, 5, 0, 0, 0, 1, 0, 1, 'ressources/equip/armures/robe_t1.png', 'Robe tissée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(152, 2, 2, 3, 5, 5, 1, 0, 0, 1, 0, 1, 'ressources/equip/armures/robe_t2.png', 'Robe en soie', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(153, 3, 2, 3, 5, 5, 1, 0, 1, 2, 0, 1, 'ressources/equip/armures/robe_t3.png', 'Robe en soie renforcée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(154, 4, 2, 3, 5, 10, 1, 1, 1, 2, 0, 2, 'ressources/equip/armures/robe_t4.png', 'Robe en argent', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(155, 5, 2, 3, 10, 10, 1, 1, 1, 2, 1, 2, 'ressources/equip/armures/robe_t5.png', 'Robe en argent renforcée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(156, 6, 2, 3, 10, 10, 2, 2, 1, 3, 1, 2, 'ressources/equip/armures/robe_t6.png', 'Robe en or', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(157, 7, 2, 3, 10, 15, 2, 2, 2, 3, 1, 3, 'ressources/equip/armures/robe_t7.png', 'Robe en or renforcée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(158, 8, 2, 3, 15, 15, 2, 2, 2, 3, 1, 3, 'ressources/equip/armures/robe_t8.png', 'Robe de l''ombre', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(159, 9, 2, 3, 15, 15, 3, 2, 2, 3, 1, 3, 'ressources/equip/armures/robe_t9.png', 'Robe de l''ombre renforcée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(160, 10, 2, 3, 15, 20, 3, 2, 3, 4, 2, 3, 'ressources/equip/armures/robe_t10.png', 'Robe d''émeraude', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(161, 11, 2, 3, 20, 20, 4, 2, 3, 4, 2, 4, 'ressources/equip/armures/robe_t11.png', 'Robe d''émeraude renforcée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(162, 12, 2, 3, 20, 25, 4, 3, 3, 4, 2, 4, 'ressources/equip/armures/robe_t12.png', 'Robe de saphir', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(163, 13, 2, 3, 25, 25, 5, 3, 3, 5, 2, 4, 'ressources/equip/armures/robe_t13.png', 'Robe de saphir renforcée', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(164, 14, 2, 3, 25, 25, 5, 3, 4, 5, 2, 4, 'ressources/equip/armures/robe_t14.png', 'Robe sanguine', 0, 0, 0, '');");
        rq.request("INSERT INTO OBJET VALUES(165, 15, 2, 3, 30, 30, 6, 4, 5, 6, 3, 5, 'ressources/equip/armures/robe_t15.png', 'Robe sanguine renforcée', 0, 0, 0, '');");
